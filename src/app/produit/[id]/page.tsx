    ...
    <main className="min-h-screen pt-20 bg-[var(--bg)]">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="mb-8 text-[var(--text-secondary)] text-sm">
          ...
          <span className="mx-2">/</span>
          <span className="text-[var(--text)]">{produit.nom}</span>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            <p className="text-[var(--text-secondary)] uppercase text-sm tracking-wider mb-2">{produit.categorie}</p>
            <h1 className="text-4xl font-bold mb-4 text-[var(--text)]">{produit.nom}</h1>
            <p className="text-3xl font-bold mb-6 text-[var(--text)]">{formatCFA(produit.prix)}</p>
            ...
            <div className="bg-[var(--bg-card)] rounded-xl p-4 mb-8 border border-[var(--border)]">
              <p className="text-sm text-[var(--text-secondary)]">
                <span className="font-semibold text-[var(--text)]">Matière :</span> {produit.matiere}
              </p>
            </div>
