        ...
        <div className="bg-gray-900 rounded-lg p-8">
          ...
          <form className="space-y-6">
            ...
            <div className="text-right">
              <Link href="/auth/mot-de-passe-oublie" className="text-sm text-gray-400 hover:text-white">
                Mot de passe oublié ?
              </Link>
            </div>
          ...
          {/* Boutons sociaux */}
          <button className="w-full border border-gray-700 text-white py-3 rounded-full font-semibold hover:bg-gray-800 transition mb-3 flex items-center justify-center gap-2">
          ...
          <button className="w-full border border-gray-700 text-white py-3 rounded-full font-semibold hover:bg-gray-800 transition flex items-center justify-center gap-2">
